...
export default function HomeVideo() {
  ...
  return (
    <section className="pb-40 pt-6">
      ...
      <div className="pt-20 max-w-[85vw] w-full mx-auto space-y-[6vw]">
        <h3 className=" font-medium text-center lg:font-bold text-[6.5vw] md:text-[5vw] lg:text-[3vw] lg:tracking-tight lg:leading-[150%] leading-[160%] ">

...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    {
      id: 4,
      question: "How do I measure return on investment on my social media advertising?",
      answer: "We provide detailed analytics and reporting to track key metrics including cost per acquisition, conversion rates, and revenue attribution. Our dashboard gives you real-time insights into campaign performance and ROI."
    },
    {
      id: 5,
      question: "What's the difference between social media marketing and paid social media advertising?",
      answer: "Social media marketing includes organic content creation, community management, and brand building. Paid social media advertising involves promoting content through paid placements to reach specific audiences and drive measurable results."
    },
    {
      id: 6,
      question: "What's the difference between a boosted post and an ad on Facebook?",
      answer: "A boosted post is a simple way to promote existing organic content to a broader audience. Facebook ads offer more advanced targeting options, multiple ad formats, and detailed campaign management tools for more sophisticated marketing strategies."
    }
  ];

...
export default function PartnersForGrowth() {
  const faqItems = [
    {
          ...
          <div className="flex gap-2 lg:gap-6 w-full justify-between px-4 lg:px-16">
            ...
            <div className="flex flex-col gap-2 lg:gap-6 w-[30%]">
              <div
                ...
                style={{
                  backgroundImage: "url('/partners-for-growth/1.png')",
              ...
              <div
                ...
                style={{
                  backgroundImage: "url('/partners-for-growth/2.png')",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                }}
              />
            ...
            <div className="flex flex-col item-center justify-end w-[40%]">
              <div
                ...
                style={{
                  backgroundImage: "url('/partners-for-growth/3.png')",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                }}
              />
            ...
            <div className="flex flex-col gap-2 lg:gap-6 w-[30%]">
              <div
                className="w-full h-[72px] md:h-[236px] md:rounded-[12px] rounded-[6px]"
                style={{
                  backgroundImage: "url('/partners-for-growth/4.png')",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                }}
              />
              <div
                className="w-full h-[72px] md:h-[236px] md:rounded-t-[12px] rounded-t-[6px]"
                style={{
                  backgroundImage: "url('/partners-for-growth/5.png')",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                }}
              />
          ...
          <div className="relative">
            <Accordion type="single" collapsible className="w-full z-10">
              {phases.map((phase, index) => (
                ...
                >
                  <AccordionTrigger className="hover:no-underline py-4 lg:py-6">
                    <div className="flex items-center justify-between w-full pr-4">
                      <div className="flex items-center gap-3 lg:gap-4 flex-1">
                        {phase.duration ? (
                          <p className="font-manrope font-semibold text-[#0224e9] text-[12px] leading-[12px] whitespace-nowrap min-w-[68px]">
                            {phase.duration}
                          </p>
                        ) : (
                          <span className="inline-block min-w-[68px]" />
                        )}
                  ...
                  <AccordionContent className="font-inter text-[14px] lg:text-[18px] text-[rgba(51,51,51,0.8)] leading-[22px] lg:leading-[28px] pb-4 lg:pb-6 pl-[60px] lg:pl-[80px]">
                    {phase.description}
                  </AccordionContent>
                </AccordionItem>
              ))}
            ...
            <Accordion type="single" collapsible className="w-full">
              {faqItems.map((item, index) => (
                <AccordionItem
                  ...
                  className="border-b border-[#333333]/20"
                >
                  <AccordionTrigger className="font-inter font-medium text-[14px] lg:text-[26px] text-[#333333] text-left hover:no-underline py-4 lg:py-6">
                    {item.question}
                  </AccordionTrigger>
